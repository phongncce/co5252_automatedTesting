...
public class TC011011Test {
    ...
    public void tC011011() {
        ...
        driver.findElement(By.id("id_grade")).sendKeys("A+");
        ...
        {
            WebElement element = driver.findElement(By.cssSelector(".img-rounded"));
