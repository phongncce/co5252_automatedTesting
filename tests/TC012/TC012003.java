...
public class TC012003Test {
    ...
    public void tC012003() {
        ...
        driver.findElement(By.id("id_error_extensionduedate")).click();
        driver.findElement(By.id("id_extensionduedate_enabled")).click();
        driver.findElement(By.id("id_submitbutton")).click();
